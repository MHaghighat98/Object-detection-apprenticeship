...
#cap = cv2.VideoCapture("http://192.168.1.16:8080/shot.jpg") 
#we have captured the video via url so this step was hashtaged 
...
#we have accessed the model by downloading it seperatly and cd into the directory and extract it
...
# get the Model
tar_file = tarfile.open('faster_rcnn_inception_v2_coco_2018_01_28.tar.gz', "r:gz")
...
#using the IP to start the transportation
